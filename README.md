...
- Especial interesse em **desenvolvimento Back-End**, com foco em:
  - **APIs RESTful** com **Node.js** e **Python Flask**  
...
Atualmente me aprofundando em **JavaScript**, **Python** e **lógica de programação**, sempre buscando construir aplicações robustas e bem estruturadas.

---

## 🧩 Metodologias e processos

- Experiência com **metodologias ágeis** como **Scrum**, visando aumentar a colaboração e a entrega contínua  
- Conhecimento em **processos de análise de sistemas**:  
...
- Dominar o desenvolvimento de **APIs RESTful**   
